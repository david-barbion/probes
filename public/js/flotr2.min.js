...
Flotr.addType('lines', {
  ...
  plot : function (options, shadowOffset, incStack) {
	...
	// To handle the staked lines, we will close the line into a
	// filled shape that follow the previous line.

        // Our position is at the end of the line, so we continue to
